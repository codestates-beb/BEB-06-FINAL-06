...
app.use('/user',require('./routes/user.route'))     // 유저관련 라우터
app.use('/item',require('./routes/item.route'))     // 아이템(1155) 관련 라우터
app.use('/nft',require('./routes/nft.route'))       // NFT(721) 관련 라우터
app.use('/game',require('./routes/game.route'))     // 게임관련 라우터
app.use('/web3',require('./routes/web3.route'))     // web3 관련 라우터
